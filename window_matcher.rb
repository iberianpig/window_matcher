...
class WindowMatcher
  ...
  def desktop_files
    @matcher.RunningApplicationsDesktopFiles
  end

  def applications
    desktop_files.map do |file|
      {
        desktop_file: file,
  ...
  def active_application_name
    return if active_application.nil?

    desktop_file = active_application[:desktop_file]
    find_name(desktop_file)
  end

  def active_application
    applications.find { |app| app[:application_id] == active_application_id }
  end
